...
class CampusControllerTest < ActionController::TestCase
  ...
  test "should create campu" do
    assert_difference('Campu.count') do
      post :create, campu: { city: @campu.city, name: @campu.name, phone_number: @campu.phone_number, state: @campu.state, zip_code: @campu.zip_code }
    end
  ...
  test "should update campu" do
    patch :update, id: @campu, campu: { city: @campu.city, name: @campu.name, phone_number: @campu.phone_number, state: @campu.state, zip_code: @campu.zip_code }
    assert_redirected_to campu_path(assigns(:campu))
  end
